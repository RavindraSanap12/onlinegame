package com.OnlineGame.backend.Games.DoublePatti.dto;
...
public class DoublePattiDTO {
    ...
    // Constructors
    public DoublePattiDTO() {
    }

    public DoublePattiDTO(Map<String, Map<String, Integer>> digitValues) {
